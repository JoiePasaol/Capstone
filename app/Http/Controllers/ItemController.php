...
class ItemController extends Controller
{
    ...
    public function transfer(Request $request)
    {
        ...
        try {
            ...
            // Create transferred item record (don't deduct quantity yet)
            ...
            // Send email to the first signatory in the approval chain
    ...
    protected function sendTransferNotifications($transferredItem)
    {
        ...
        if ($signatory && $signatory->email) {
            ...
            // Initialize approval_status to track the progress
            $approvalStatus = [
                'current_approval_step' => 0 // Index of the first step in approvalOrder
            ];
